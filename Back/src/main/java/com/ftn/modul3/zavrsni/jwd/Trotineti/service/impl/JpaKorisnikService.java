...
import com.ftn.modul3.zavrsni.jwd.Trotineti.enumeration.KorisnickaUloga;
...
public class JpaKorisnikService implements KorisnikService {
    ...
    public Page<Korisnik> findAll(int brojStranice) {
        return korisnikRepository.findAll(PageRequest.of(brojStranice,3));
    }
	...
	@Override
	public Optional<Korisnik> findOneByEmail(String email) {
